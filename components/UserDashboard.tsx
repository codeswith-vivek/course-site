...
const UserDashboard: React.FC<UserDashboardProps> = ({ 
  ...
  const isPlayableResource = (resource: Resource) => {
    ...
    // A generic link that's not a known downloadable file type and not a PDF (PDFs go to download/external)
                                            ...
                                            return (
                                                <div key={res.id} className="border-b border-slate-100 pb-6 last:border-0">
                                                    <div className="flex items-center justify-between mb-4">
                                                        ...
                                                        {res.type === 'FILE' && !isVideoPlayable && ( // Condition for downloadable files
                                                            <a 
                                                                href={res.url} 
                                                                download
                                                                target="_blank"
                                                    ...
                                                    <div className="pl-9">
                                                        {isVideoPlayable ? (
                                                            ...
                                                            // Default display for other files/links (including PDFs)
